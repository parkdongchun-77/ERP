...
- [x] 자동분개(판매/구매/수금/지급/급여) — SQL 검증: 4건 분개, 시산표 82,000=82,000, 채권/채무/매출 잔액 정확
- [x] 자동분개 계정 매핑 설정 — journal_account_map + 설정 화면(관리자). SQL 검증: sale_revenue를 404로 변경 시 분개가 404로 기표
